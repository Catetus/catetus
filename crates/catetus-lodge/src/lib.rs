#![deny(clippy::all)]
//! `catetus-lodge` — offline builder for the LODGE-style hierarchical
//! level-of-detail pyramid used by the Catetus viewer.
//!
...
use catetus_core::{Splat, SplatScene};
...
pub fn build(
    ...
    let level_indices: Vec<Vec<u32>> = {
        ...
        for _l in 1..opts.levels {
            ...
            let target = ((prev.len() as f32) / opts.coarsen_ratio).round() as usize;
