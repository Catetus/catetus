...
# fixture corpus into `crates/catetus-usd-conformance/fixtures/`.
#
...
out_dir="$repo_root/crates/catetus-usd-conformance/fixtures"

cd "$repo_root"
rm -rf "$out_dir"
mkdir -p "$out_dir"

cargo run --quiet -p catetus-usd-conformance --bin catetus-usd-fixtures -- "$out_dir"
