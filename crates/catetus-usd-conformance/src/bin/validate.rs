//! `catetus-usd-validate` — CLI driver for the OpenUSD
//! `ParticleField3DGaussianSplat` conformance suite.
//!
//! Usage:
//!     catetus-usd-validate <file.usda|file.usdc> [--json] [--quiet]
//!
//! Exit codes:
...
use catetus_usd_conformance::{validate_path, Clause, Status};
use clap::Parser;

#[derive(Parser, Debug)]
#[command(
    name = "catetus-usd-validate",
