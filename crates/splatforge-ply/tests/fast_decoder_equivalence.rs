...
fn decode_reference(bytes: &[u8], props: &[PropSpec], n: usize) -> SplatScene {
    ...
    for i in 0..n {
        ...
        let f_rest: Vec<(usize, f32)> = props
            ...
            .enumerate()
            .filter_map(|(k, p)| {
                p.name.strip_prefix("f_rest_").and_then(|s| s.parse::<usize>().ok()).map(
                    |_idx| {
                        let b: [u8; 4] = row[k * 4..k * 4 + 4].try_into().unwrap();
...
fn ordering_minimal() -> Vec<PropSpec> {
    vec![
        PropSpec { name: "x", gen: gen_x },
        PropSpec { name: "y", gen: gen_y },
        PropSpec { name: "z", gen: gen_z },
        PropSpec { name: "scale_0", gen: gen_scale_0 },
        PropSpec { name: "scale_1", gen: gen_scale_1 },
        PropSpec { name: "scale_2", gen: gen_scale_2 },
        PropSpec { name: "rot_0", gen: gen_rot_0 },
        PropSpec { name: "rot_1", gen: gen_rot_1 },
        PropSpec { name: "rot_2", gen: gen_rot_2 },
        PropSpec { name: "rot_3", gen: gen_rot_3 },
        PropSpec { name: "opacity", gen: gen_opacity },
        PropSpec { name: "f_dc_0", gen: gen_dc_0 },
        PropSpec { name: "f_dc_1", gen: gen_dc_1 },
        PropSpec { name: "f_dc_2", gen: gen_dc_2 },
    ]
}
...
fn ordering_inria_degree1() -> Vec<PropSpec> {
    let mut v = vec![
        ...
        PropSpec { name: "y", gen: gen_y },
        PropSpec { name: "z", gen: gen_z },
        PropSpec { name: "nx", gen: gen_norm },
        PropSpec { name: "ny", gen: gen_norm },
        PropSpec { name: "nz", gen: gen_norm },
        PropSpec { name: "f_dc_0", gen: gen_dc_0 },
        PropSpec { name: "f_dc_1", gen: gen_dc_1 },
        PropSpec { name: "f_dc_2", gen: gen_dc_2 },
    ];
    ...
    for k in 0..9 {
        ...
        v.push(PropSpec { name, gen: gen_f_rest_k(k) });
    }
    v.push(PropSpec { name: "opacity", gen: gen_opacity });
    v.push(PropSpec { name: "scale_0", gen: gen_scale_0 });
    v.push(PropSpec { name: "scale_1", gen: gen_scale_1 });
    v.push(PropSpec { name: "scale_2", gen: gen_scale_2 });
    v.push(PropSpec { name: "rot_0", gen: gen_rot_0 });
    v.push(PropSpec { name: "rot_1", gen: gen_rot_1 });
    v.push(PropSpec { name: "rot_2", gen: gen_rot_2 });
    v.push(PropSpec { name: "rot_3", gen: gen_rot_3 });
    v
}
...
fn ordering_shuffled_dc_rest_degree1() -> Vec<PropSpec> {
    vec![
        PropSpec { name: "opacity", gen: gen_opacity },
        PropSpec { name: "x", gen: gen_x },
        PropSpec { name: "f_rest_0", gen: gen_f_rest_k(0) },
        PropSpec { name: "y", gen: gen_y },
        PropSpec { name: "f_dc_0", gen: gen_dc_0 },
        PropSpec { name: "rot_0", gen: gen_rot_0 },
        PropSpec { name: "f_rest_1", gen: gen_f_rest_k(1) },
        PropSpec { name: "z", gen: gen_z },
        PropSpec { name: "f_dc_1", gen: gen_dc_1 },
        PropSpec { name: "rot_1", gen: gen_rot_1 },
        PropSpec { name: "f_rest_2", gen: gen_f_rest_k(2) },
        PropSpec { name: "scale_0", gen: gen_scale_0 },
        PropSpec { name: "f_dc_2", gen: gen_dc_2 },
        PropSpec { name: "rot_2", gen: gen_rot_2 },
        PropSpec { name: "f_rest_3", gen: gen_f_rest_k(3) },
        PropSpec { name: "scale_1", gen: gen_scale_1 },
        PropSpec { name: "f_rest_4", gen: gen_f_rest_k(4) },
        PropSpec { name: "rot_3", gen: gen_rot_3 },
        PropSpec { name: "f_rest_5", gen: gen_f_rest_k(5) },
        PropSpec { name: "scale_2", gen: gen_scale_2 },
        PropSpec { name: "f_rest_6", gen: gen_f_rest_k(6) },
        PropSpec { name: "f_rest_7", gen: gen_f_rest_k(7) },
        PropSpec { name: "f_rest_8", gen: gen_f_rest_k(8) },
    ]
}
...
fn assert_scenes_equal(a: &SplatScene, b: &SplatScene) {
    ...
    for (i, (sa, sb)) in a.splats.iter().zip(b.splats.iter()).enumerate() {
        ...
        match (&sa.color, &sb.color) {
            ...
            (
                Color::Sh { degree: da, coeffs: ca },
                Color::Sh { degree: db, coeffs: cb },
            ) => {
