//! `catetus-khr-validate` — CLI driver for the conformance suite.
//!
//! Usage:
//!     catetus-khr-validate <file.gltf|file.glb> [--json] [--quiet]
//!
//! Exit codes:
...
use catetus_khr_conformance::{validate_path, Clause, Status};
use clap::Parser;

#[derive(Parser, Debug)]
#[command(
    name = "catetus-khr-validate",
