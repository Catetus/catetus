...
Notes captured while implementing the Catetus USDC writer (May 2026).
...
`custom float[] catetus:shCoefficients`. Layout: `n_splats * (degree+1)^2 * 3`
...
**Status:** Catetus ships LODs as a `lod` variant set on the splat prim
