...
//! each.  Mirrors `splatforge-khr-conformance/tests/fixtures.rs`.
//!
...
use splatforge_usd_conformance::{validate_path, Status};

fn fixtures_bin() -> PathBuf {
    PathBuf::from(env!("CARGO_BIN_EXE_splatforge-usd-fixtures"))
}
