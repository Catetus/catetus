//! Cesium 3D Tiles 1.1 tileset emitter for Catetus.
//!
...
//! `region` would require a geodetic CRS that Catetus's IR does not carry).
...
use catetus_core::{LodLevel, SplatScene};
...
pub fn write_tileset(
    ...
    let tileset = Tileset {
        asset: TilesetAsset {
            ...
            tileset_version: Some("catetus-geospatial-1".to_string()),
        },
...
mod tests {
    use super::*;
    use catetus_core::{Color, LodLevel, Splat};
