...
Command-line front end for the Catetus Gaussian-splat pipeline.

```
catetus <command> [options]
```
...
brew tap catetus/tap && brew install catetus
...
`catetus`, `catetus-khr-validate`, `catetus-usd-validate`. The
...
Run `catetus <command> --help` for the full flag list.
...
`crates/catetus-optimize/src/tileset.rs` for the full heuristic.
