...
/**
 * Construction options for {@link CatetusViewer}.
 */
...
/**
 * Discriminated event union emitted by {@link CatetusViewer}.
 *
 * Use {@link CatetusViewer.on} with the literal `type` string to subscribe.
 */
