// Android module that publishes the `SplatforgeViewer` AAR.
//
...
// `.so` files land in `src/main/jniLibs/<abi>/libsplatforge_viewer_mobile.so`.
...
android {
    namespace = "com.splatforge.viewer"
    compileSdk = 34
    defaultConfig {
        minSdk = 24
        ndk {
