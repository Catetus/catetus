// SplatforgeShaders — resource-only Swift target that hosts the MSL compute
// kernels (`*.metal`) for the iOS viewer. Both the main `SplatforgeViewer`
// target and the `SplatforgeViewerTests` target depend on this so the
