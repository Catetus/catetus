...
// non-Catetus output format requires a viewer that can decode it. SOG
// support lands when catetus-spz's SOG reader path is wired in; for now
...
const report = {
  schema: "catetus.splatbench.encoders/0.1",
