...
Runs the Catetus **QAT codec for Scaffold-GS** PLYs. This is a
...
`catetus-qat-scaffold` endpoint and stores whatever comes back, plus a
...
endpoint a Catetus API user would hit.
...
```
export CATETUS_QAT_ENDPOINT=https://api.catetus.com
export CATETUS_QAT_TOKEN=$YOUR_API_KEY
