...
- Bug? → [open an issue](https://github.com/montabano1/SplatForge/issues/new?template=bug.md)
- Feature idea? → [open an issue](https://github.com/montabano1/SplatForge/issues/new?template=feature.md)
- Want to contribute a real splat to the benchmark corpus? → [corpus request](https://github.com/montabano1/SplatForge/issues/new?template=corpus_request.md)
- Pull request? → see below.

## Engineering principles

SplatForge is **spec-driven** and **test-first**.
...
4. **Sign off your commits with DCO.** SplatForge uses the
...
- Training Gaussian Splats from images/video (use Polycam, PostShot, Inria
  3DGS, etc. — SplatForge consumes their output).
