...
The optional `CT_spatial_streaming_index` extension is defined in SPEC-0007.
...
Scenario: Export PLY to glTF KHR
  ...
  When I run "catetus convert tiny/basic_binary.ply --to gltf --out scene.gltf"
  Then scene.gltf exists
  And the glTF declares the Gaussian Splatting extension
  And "catetus inspect scene.gltf" succeeds

Scenario: Import glTF KHR
  Given fixture "tiny/basic_khr.gltf"
  When I run "catetus analyze tiny/basic_khr.gltf"
