 ...
 *
 * The HTML is rendered via `@splatforge/report-ui` so the diff CLI and the
...
import { renderDiffReport, renderParityReport } from '@splatforge/report-ui';
...
<html lang="en"><head><meta charset="utf-8"><title>SplatForge report</title>
<style>
