...
1. Boots a `t4`-class container with the catetus CLI + Playwright + Chromium
...
python3 -m modal volume get catetus-fidelity-results \
...
- **Annually**, to track drift as the catetus codec evolves.
