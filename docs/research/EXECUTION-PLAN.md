...
responses (`splatforge-private/research/llm-brainstorm-*` for the raw inputs)
and integrate the winning techniques into the SplatForge stack. Each item is
...
1. Every experiment appends to `splatforge-private/research/EXECUTION-LOG.md`
...
4. Stealth: no third-party `gh issue create`. Anything that names humans,
   partners, or outreach lives in `splatforge-private/`.
...
All experiment results: `splatforge-private/research/EXECUTION-LOG.md`.
Raw DRA responses: `splatforge-private/research/llm-brainstorm-*.md`.
