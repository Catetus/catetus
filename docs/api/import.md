...
the standard Catetus optimize pipeline. The motivation: skip the
...
- **Env overrides.** Operators can repoint any of the three providers via
  `CATETUS_LUMA_API_BASE`, `CATETUS_POLYCAM_CDN_BASE`,
  `CATETUS_SCANIVERSE_CDN_BASE` (useful for staging or smoke tests
