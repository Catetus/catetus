...
wire format. Drop-in SwiftPM module for the SplatForge iOS viewer.
...
.package(url: "https://github.com/splatforge/SplatForge.git",
         from: "0.1.0", path: "apps/ios/SplatForgeQATKernel")
```

Or in Xcode: File > Add Packages > paste the SplatForge repo URL, pick
`SplatForgeQATKernel`.

## Build & test

```bash
cd apps/ios/SplatForgeQATKernel
