 ...
 *
 * Talks to `GET /v1/me/usage` on splatforge-api. The bearer token is
 * read from `localStorage.splatforge.apiKey` — the same key the
 ...
 * out of the box on splatforge.dev; a contributor running a local
 * API sets `localStorage.splatforge.apiBase` to override.
 *
...
export const DASHBOARD_API_KEY_STORAGE = "splatforge.apiKey";
export const DASHBOARD_API_BASE_STORAGE = "splatforge.apiBase";
export const DEFAULT_API_BASE = "https://splatforge-api.fly.dev";
