 ...
 */
import { LodgeChunkLoader } from './chunk-loader.js';
import { LOD_MAX_LEVELS, pickNearFarChunks, selectAllActivations, } from './lod-math.js';
...
export class LodgeLODPipeline {
    ...
    prepareFrame(cameraPos, focalY) {
        ...
        const depthThresholds = new Array(LOD_MAX_LEVELS).fill(Number.POSITIVE_INFINITY);
     ...
     */
    async streamFrame(cameraPos, focalY) {
    ...
    async warmLevel(level, cameraPos) {
    ...
    encodeLodSelectUniforms(decision, cameraPos, focalY) {
...
//# sourceMappingURL=lod-pipeline.js.map