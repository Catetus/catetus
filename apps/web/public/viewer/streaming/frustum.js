 ...
 * Catetus tilesets are local-frame axis-aligned, the three half-axis
 ...
 */
export function extractFrustum(m) {
 ...
 * three half-axis triples are axis-aligned (the only form the Catetus
 ...
 * one.
 */
export function aabbFromObb12(obb) {
    if (obb.length !== 12) {
 ...
 */
export function aabbIntersectsFrustum(box, frustum) {
 ...
 */
export function distanceFromCamera(box, eye) {
