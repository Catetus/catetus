 ...
 */
export function computeCovariance3D(scale, rot) {
 ...
 */
export function projectCovariance2D(cov3d, viewMatrix, focalX, focalY, depth) {
 ...
 */
export function projectPoint(p, viewProj) {
 ...
 */
export function buildViewProj(camera, aspect, fov) {
