...
Targets covered (status reported per target as PASS/FAIL/SKIP):
  ...
  4. iOS     — apps/ios/CatetusQATKernel/  (runs swift test)
  5. Android — apps/android/catetus-qat-vulkan/  (cmake configure + glsl compile)
...
IOS_DIR  = ROOT / "apps" / "ios" / "CatetusQATKernel"
AND_DIR  = ROOT / "apps" / "android" / "catetus-qat-vulkan"
