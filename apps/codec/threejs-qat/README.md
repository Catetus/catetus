# @splatforge/three-qat

A Three.js loader for **SplatForge QAT-PLY**, a quantized PLY container for
3D Gaussian-splat scenes. Decodes the constant-strip, int8, and int4 paths
specified by the SplatForge codec.

## Install

```bash
npm install three @splatforge/three-qat
```
...
import { QATPlyLoader } from "@splatforge/three-qat";
...
See [the QAT-PLY spec](https://github.com/montabano1/SplatForge/tree/main/specs) for the on-disk byte layout.
