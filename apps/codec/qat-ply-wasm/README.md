# @catetus/qat-ply-wasm

WebAssembly build of the [Catetus QAT-PLY v1](../qat-ply-c/) reference C
...
```bash
pnpm add @catetus/qat-ply-wasm
# or
npm i @catetus/qat-ply-wasm
```
...
```js
import createQatPlyModule from "@catetus/qat-ply-wasm";
