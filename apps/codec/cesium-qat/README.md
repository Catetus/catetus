...
A CesiumJS `DataSource` that decodes **Catetus QAT-PLY** and places the
...
for geographic apps that want Catetus scenes alongside their 3D Tiles /
imagery layers.

## Install

```bash
npm install cesium @catetus/cesium-qat
```
...
import { QATPlyDataSource } from "@catetus/cesium-qat";
