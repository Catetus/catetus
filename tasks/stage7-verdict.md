...
4. **4090 verify harness** (`tasks/scripts/run_stage7_verify.mjs` +
   ...
   `C:/Users/monta/Catetus/.bench-scenes/sweet-corals-full.lodge/`
...
| Gate | Result |
|---|---|
| `pnpm --filter @catetus/viewer test` | **207/207 PASS** |
| Viewer build (`pnpm --filter @catetus/viewer build`) | **clean** |
