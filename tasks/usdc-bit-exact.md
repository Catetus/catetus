...
- [ ] Wire into CLI convert: `splatforge convert in.usda out.usdc --to usdc`.
...
- [ ] `crates/splatforge-usd/SPEC-GAPS.md`.
...
- optional `splatforge:shCoefficients` custom float[] when scene has SH
